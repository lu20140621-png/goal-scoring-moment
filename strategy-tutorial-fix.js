    ...
    try{
      w.eval(`
        (function(){
          ...
          const __gsmOriginalActiveName=activeName;
          activeName=function(){
            ...
            return __gsmOriginalActiveName();
          };
          ...
          const __gsmOriginalOnCard=onCard;
          onCard=function(name){
            ...
            return __gsmOriginalOnCard(name);
          };

          const __gsmOriginalRender=render;
          render=function(){
            __gsmOriginalRender();
            if(idx!==7)return;
      ...
      console.error('Lesson 8 fix failed',e);
    }
  }

  frame.addEventListener('load',()=>{applyLesson8Fix();setTimeout(applyLesson8Fix,200)});
  if(frame.contentDocument&&frame.contentDocument.readyState!=='loading')applyLesson8Fix();
})();
