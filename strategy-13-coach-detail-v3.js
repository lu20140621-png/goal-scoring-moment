...
(() => {
  ...
  const DETAIL = {
    ...
    7: 'GREEN 1 has played SHOOT at you. Now play a legal defensive card from your hand: DEFENSE or TACKLE. YELLOW does not stop an attack.',
    8: 'GREEN 2 has the Soccer Card. Play TACKLE from your hand to take the Soccer Card and win possession.',
    ...
    12: 'FINAL CHALLENGE: First stop the incoming SHOOT with DEFENSE or TACKLE. If GREEN uses DRIBBLE PAST, defend again. Then discard one card, play SHOOT, and tap the opponent you want to target.'
  };
